...
{
    public class MgtsemployeeDTO : EntityMap<Mgtsemployee>
    {
        public MgtsemployeeDTO()
        {
            Map(p => p.IgniteUserApplication).Ignore();
            Map(p => p.IgniteUserRoleTypeMgtsemployee).Ignore();
        }
